# Generated by Django 4.1.5 on 2023-03-17 14:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ticket', '0021_feuilleapikey_facturesapikey_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='api_keys', to='ticket.profile')),
            ],
            options={
        ...
        migrations.RemoveField(
            model_name='attachementimageticketapikey',
            name='attachement_image_ticket',
        ),
        migrations.RemoveField(
            model_name='facturesapikey',
            name='factures',
        ),
        migrations.RemoveField(
            model_name='feuilleapikey',
            name='feuille',
        ),
